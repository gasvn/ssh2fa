...
impl Method {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Method::HostListDir => "host_list_dir",
            Method::CredentialsConsolidate => "credentials_consolidate",
            Method::HostMounts => "host_mounts",
            Method::HostMountRepair => "host_mount_repair",
    ...
    pub fn from_str(s: &str) -> Option<Method> {
        match s {
            ...
            "host_list_dir" => Some(Method::HostListDir),
            "credentials_consolidate" => Some(Method::CredentialsConsolidate),
            "host_mounts" => Some(Method::HostMounts),
            "host_mount_repair" => Some(Method::HostMountRepair),
